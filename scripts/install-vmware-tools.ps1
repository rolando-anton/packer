...
#} else {
#    $download_url = "https://packages.vmware.com/tools/esx/6.7ep2a/windows/$iso_name"
#}
# change the following URL with a public or local location of the ISO file, for save bandwidht I made it local. Otherwise it could be:
# https://packages.vmware.com/tools/esx/6.7ep2a/windows/VMware-tools-windows-10.2.1-8267844.iso which may vary depending of the version you need/want of the VMTools.

$download_url = "http://10.10.10.15/VMware-tools-windows-10.2.1-8267844.iso"
...
$process = Execute-Vmware -setupPath "c:\windows\temp\vmware\setup64.exe"
